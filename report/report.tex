...
\begin{enumerate}
	...
	\begin{figure}[htbp]
	  \centering
	  \includegraphics[width=.23\textwidth]{FIGS/hedcut/svg/phoenix-h1}
	  \includegraphics[width=.23\textwidth]{FIGS/hedcut/svg/phoenix-h2}
	  \includegraphics[width=.23\textwidth]{FIGS/hedcut/svg/phoenix-h3}
	...
	\begin{figure}[htbp]
 	 \centering
 	 \includegraphics[width=.23\textwidth]{FIGS/voronoi/svg/phoenix-v1}
 	 \includegraphics[width=.23\textwidth]{FIGS/voronoi/svg/phoenix-v2}
 	 \includegraphics[width=.23\textwidth]{FIGS/voronoi/svg/phoenix-v3}
 	 \caption{phoenix with 5000}
	\end{figure}
\end{enumerate}
